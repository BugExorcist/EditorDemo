...
public class 普攻动作选择 : MonoBehaviour
{
    public static 普攻动作选择 instance;
    int 选择index = 0;
    private void Awake()
    {
        instance = this;
    ...
    private void Start()
    {
        列表 = Resources.LoadAll<AnimationClip>("动作列表/普攻动作");
        ...
        if (列表.Length > 0 )
        {
            ...
            obj.GetComponent<Button>().onClick.AddListener(()=> {
                ...
                选择index = 0;
                NotificationCenter.DefaultCenter.PostNotification(this,"选普攻动作","动作"+ 选择的动作 + "^"+name );
